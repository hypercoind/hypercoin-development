---
name: commit
description: Automates git commit workflow with standardized commit messages and status tracking.
---

# Commit Skill

**Automates the git commit workflow with standardized messages**
...
- `add new project to content collection`
...
2. Common issues:
   - **Nothing to commit**: Check if files were properly staged
   - **Empty commit message**: Ensure HEREDOC is properly formatted
   - **Unmerged files**: Resolve merge conflicts first
3. Report the error to the user and suggest fixes
...
Please fix the issue and try again with /commit
```
...
- `/Users/hypercoin/src/hypercoin-development/CLAUDE.md` (project guidance)
